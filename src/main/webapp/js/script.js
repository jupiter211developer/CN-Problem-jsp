...
function calcular()
{
  ...
  document.getElementById('resultado').innerHTML="Transmission Delay: " + trans_cien + " segs ou " +
  transmissao + " segs. <br>" + "Propagation Delay: " + prop_cien + " segs ou " + propagacao + " segs. <br>" +
